...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter ReportConnectionError(%d)\n", elevel);
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter ExecuteCriticalRemoteCommand(%s)\n", command);
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter ExecuteOptionalRemoteCommand(%s)\n", command);
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter SendRemoteCommand(%s)\n", command);
#endif	
