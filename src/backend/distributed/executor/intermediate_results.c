...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter PrepareIntermediateResultBroadcast()\n");
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter SendCopyDataOverConnection()\n");
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter FetchRemoteIntermediateResult()\n");
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter CopyDataFromConnection()\n");
#endif	
