...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter OpenCopyConnectionsForNewShards()\n");
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter ForwardCopyDataFromConnection()\n");
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter CopyGetPlacementConnection()\n");
#endif	
...
{
#ifndef PG_NO_DEBUG	
	fprintf(stdout, "[PG_DEBUG]enter StartPlacementStateCopyCommand()\n");
#endif	
